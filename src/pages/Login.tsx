          ...
          <Tabs defaultValue="login" className="w-full max-w-md mx-auto">
            ...
            <TabsContent value="login" className="space-y-6">
              <div className="text-center mb-8">
                <h2 className="text-2xl font-semibold text-gray-800">Good Day, User</h2>
              </div>
              ...
              <Button onClick={handleLogin} className="w-full bg-green-500 hover:bg-green-600 text-white py-3 mt-8">
                LOGIN
              </Button>
